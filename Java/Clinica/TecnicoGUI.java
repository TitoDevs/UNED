...
/**
 * Write a description of class TecnicoGUI here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class TecnicoGUI{
  public JLabel userLabel, passwordLabel, success, image, profile, background;
    ...
    public TecnicoGUI(Personas personas, PruebasDiagnosticas pruebasDiagnosticas, Empleados empleados,
    Pacientes pacientes){
    ...
    public void makeMenuBar(JFrame frame, Personas personas, PruebasDiagnosticas pruebasDiagnosticas, Empleados empleados, Pacientes pacientes)
    {
        ...
        item = new JMenuItem("Cambiar a enfermero");
    ...
    public void listadoPacientes(Empleados empleados, Pacientes pacientes){
        ...
        buscar.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                String idTec = tfbuscar.getText().toString();
                Object[] column = new Object[model.getColumnCount()];
                model.setRowCount(0);
                if(idTec != ""){
                    for(int i = 0; i < empleados.tecnicos.size(); i++){
                        if(idTec.equals(empleados.tecnicos.get(i).getID())){
                            for(int j = 0; j < empleados.tecnicos.get(i).listPacAsignados.size();j++){
                                for(int k = 0; k < pacientes.listPacientes.size(); k++){
                                    if(empleados.tecnicos.get(i).listPacAsignados.get(j).getIdPaciente().equals(pacientes.listPacientes.get(k).getID())){
    ...
    public void registroPruebas(Empleados empleados, Pacientes pacientes){
        ...
        Font fuente2 = new Font("Calibri", 1, 20);
        JLabel tf_subtitulo = new JLabel("Registro y actualización los resultados de las pruebas diagnósticas");
        tf_subtitulo.setBounds(10, 80, 700, 20);
        tf_subtitulo.setFont(fuente2);
        ...
        JButton bt_asignarTecnico = new JButton("Asignar resultado");
        ...
        bt_asignarTecnico.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                Prueba prueba = new Prueba(empleados, pacientes);
            }
        });
